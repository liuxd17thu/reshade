...
bool reshade::ini_file::import_section(const std::vector<std::string> &lines, std::unordered_map<std::string, std::vector<std::string>> &data)
{
	data.clear();
...
bool reshade::ini_file::export_section(const std::unordered_map<std::string, std::vector<std::string>> &keys, std::string &lines)
{
	std::string data;
