...
bool reshade::runtime::init_gui_vr()
{
	...
	const vr::EVROverlayError overlay_e = vr::VROverlay()->CreateDashboardOverlay("aurorashade", "AuroraShade " VERSION_STRING_CN2, &s_vr_overlay_handle, &s_vr_thumbnail_handle);
